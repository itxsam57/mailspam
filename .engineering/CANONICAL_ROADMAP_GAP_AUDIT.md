...
| 10,000 simulated clients report and consume signed rules without duplicate inflation | MISSING | Current aggregate persistence rewrites the whole encrypted database per report. A durable bounded journal/snapshot architecture and blocking capacity test are required. |
