...
const requiredFiles = [
  ...
  "scripts/engineering/check-capacity-budgets.mjs",
  "scripts/engineering/capacity-plan.mjs",
  "scripts/engineering/check-public-docs.mjs",
  "config/capacity/v1/community-baseline.json",
