...
const requiredFiles = [
  ...
  ".engineering/ACCESSIBILITY_LOCALIZATION_SAFETY.md",
  ".engineering/M3_OPERATIONS_VAULT_COMPATIBILITY.md",
  ...
  "fixtures/provider-compatibility/v1/capabilities.json",
  "fixtures/regression-vault/v1/manifest.json",
  "scripts/engineering/check-provider-compatibility.mjs",
  "scripts/engineering/check-regression-vault.mjs",
  "scripts/engineering/regression-vault-cli.mjs",
...
for (const script of [
  ...
  "check:web", "check:core", "generate:core-vectors", "check:core-vectors", "check:provider-compatibility", "check:regression-vault", "vault", "smoke:server", "smoke:community", "smoke:background", "smoke:release", "audit:inventory", "audit:prod",
