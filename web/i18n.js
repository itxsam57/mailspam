(() => {
  ...
  const english = Object.freeze({
    ...
    'background.help': 'Runs one resource-bounded Quick Scan at a time. Manual scans take priority. Previously reported campaigns and blocked senders/domains may be moved to Trash automatically for this account; ad-hoc actions and Analyze Links never run automatically.',
